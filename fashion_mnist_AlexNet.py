...
def training(level_num, description):
  ...
  train_data_path = [os.getenv("HOME")+"/fashion_mnist_data_TFRecord/"+'train'+str(i)+".tfrecord" for i in range(1,5)]
  valid_data_path = [os.getenv("HOME")+"/fashion_mnist_data_TFRecord/"+"validation.tfrecord"]
...
if __name__ == "__main__":
  ...
  for i in sample:
    description = "fashion_mnist_" + str(i) + "levels_"
